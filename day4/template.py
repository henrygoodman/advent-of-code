...
def contains(section1, section2):
    ...
    # If section 2 is larger, check that section 1 fits inside it.
...
def part1():
    ...
    for line in lines:
        ...
        # See if the smaller (size) section is contained in larger section.
        print(section1, section2, contains(section1, section2))
